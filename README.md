...
该项目已整合至 https://github.com/Harrishao/Sillytavern-Relay2-Anything ，此仓库已停止维护
...
*支持连续指令输入，指令用竖线分隔，如`/chat 0 | /regen`等效于先后输入`/chat 0`和`/regen`*
...
`/chat 0 | /regen` — 先切换到第 0 个聊天，再触发重新生成
